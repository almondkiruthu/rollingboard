...
const MarketingPage = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="relative space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 hero-background">
        <div className="absolute left-0 -z-20">
          <Image src={gradientLeft} alt={""} />
        </div>
        <div className="absolute right-0 -z-20">
          <Image src={gradientRight} alt={""} />
        </div>
        {/* <div className="absolute -z-10">
          <Image src={noiseBg} alt="" />
        </div> */}
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center z-20">
          <Link
